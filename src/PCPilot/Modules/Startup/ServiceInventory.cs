...
public static partial class ServiceInventory
{
    ...
    /// leur type de démarrage ne peut pas être modifié depuis PC Pilot (liste fermée, vérifiée aussi dans le broker).
    /// </summary>
    ...
    /// <summary>
    /// Vérifie qu'un service peut être piloté par PC Pilot : existe, n'est pas un pilote, n'est pas protégé.
