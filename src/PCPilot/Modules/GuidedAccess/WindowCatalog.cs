...
{
    /// <summary>Chemin de l'exécutable si l'application a été lancée depuis PC Pilot (permet « Relancer »).</summary>
...
/// <summary>Énumération (lecture seule) des fenêtres d'application ouvertes, hors PC Pilot et hors fenêtres système.</summary>
