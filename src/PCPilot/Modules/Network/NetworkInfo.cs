...
/// <summary>État de connectivité tel que Windows le connaît déjà (NCSI) : PC Pilot n'envoie aucune requête.</summary>
...
internal static class NetworkInfo
{
    ...
    /// <summary>Niveau de connectivité connu de Windows (API WinRT, sans trafic réseau de la part de PC Pilot).</summary>
