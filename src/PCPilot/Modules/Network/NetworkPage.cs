...
public sealed class NetworkPage : UserControl, INavigationAware
{
    ...
    public NetworkPage()
    {
        ...
        {
            Title = "Réseau",
            Subtitle = "Connexions, DNS familial ou chiffré, blocage de sites, dépannage et réseaux Wi-Fi enregistrés. PC Pilot ne contacte aucun serveur.",
            Glyph = "",
        });
        ...
        SelectTab(Environment.GetEnvironmentVariable("PCP_CAPTURE_TAB") is { Length: > 0 } devTab ? devTab : TabConnections);
    }
