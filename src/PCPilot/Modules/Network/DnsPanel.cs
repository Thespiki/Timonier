...
internal sealed class DnsPanel : UserControl
{
    ...
    private Border OptionCard(string key, string title, string description, DnsFiltering? filtering, DnsProvider? provider)
    {
        ...
        var radio = new RadioButton { GroupName = "pcp-dns-provider", Content = stack, HorizontalContentAlignment = HorizontalAlignment.Stretch, VerticalContentAlignment = VerticalAlignment.Top };
