...
internal sealed class AccountsPanel : StackPanel
{
    ...
    {
        var bar = PcPilot.UI.Controls.PageScaffold.InfoBar(text, GlyphWarning, "Pp.InfoBar.Warning");
    ...
    public async Task CreateAsync()
    {
        ...
        var standard = new RadioButton { IsChecked = true, GroupName = "pcp-users-type", Margin = new Thickness(0, 6, 0, 4) };
        ...
        var admin = new RadioButton { GroupName = "pcp-users-type", Margin = new Thickness(0, 4, 0, 4) };
