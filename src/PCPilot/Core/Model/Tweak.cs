...
/// pour ce que PC Pilot peut modifier (le broker admin refuse tout identifiant absent du catalogue).
/// </summary>
public sealed class TweakDefinition
{
    ...
    /// <summary>Option recommandée par PC Pilot (statique).</summary>
