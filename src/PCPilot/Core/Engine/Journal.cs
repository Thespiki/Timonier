...
/// <summary>Une modification appliquée par PC Pilot, avec de quoi l'annuler.</summary>
...
/// <summary>Journal utilisateur : %LOCALAPPDATA%\PCPilot\journal.json (modifications sans élévation).</summary>
...
/// <summary>
/// Journal machine : HKLM\SOFTWARE\PCPilot\Journal (une valeur par entrée). Seuls les administrateurs peuvent
