...
using PcPilot.UI.Shell;

namespace PcPilot;

public static class Program
{
    public const string ActivationEventName = @"Local\PCPilot.Activate";
    private const string MutexName = @"Local\PCPilot.SingleInstance";
    ...
    public static int Main(string[] args)
    {
        ...
        // --capture fichier.png [idPage] [light|dark] [paramètre] [défilement]
