...
/// Usage : PCPilot.exe --selftest-broker  → résultat dans %LOCALAPPDATA%\PCPilot\logs\selftest-broker.txt
/// </summary>
public static class BrokerSelfTest
{
    private const string EnvFlag = "PCPILOT_BROKER_SELFTEST";
    ...
    private static async Task<int> RunAsync()
    {
        ...
        try
        {
            ...
            {
                var psi = UnelevatedStartInfo($"--broker PCPilot.Broker.{Guid.NewGuid():N} {explorer.Id} 1");
